...
export default function CategoriesPage() {
  ...
  return (
    <div className={`${funnelSans.className} min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100`}>
      ...
      {isLoading ? (
        <div className="flex items-center justify-center min-h-[calc(100vh-80px)] pt-20 sm:pt-24 md:pt-28">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 md:py-12 pt-20 sm:pt-24 md:pt-28">
          {/* Header Section */}
