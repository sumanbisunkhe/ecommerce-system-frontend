...
export default function CustoerProfile({ user, isCurrentUser = false }: UserProfileProps) {
  const [hovered, setHovered] = useState(false);

  return (
    <div className={`bg-gray-50 py-10 px-6 rounded-lg mt-10 ${funnelSans.className}`}>
      <div className="max-w-8xl mx-auto space-y-8">
        ...
        <div className="flex items-center justify-between">
          ...
          <Link
            href={`/customer/users/${user.id}/edit`}
